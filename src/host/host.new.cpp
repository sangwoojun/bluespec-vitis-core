...
int main(int argc, char** argv) {
    ...
    std::string binaryFile = "./xclbin/kernel.hw.xclbin";
    ...
    auto krnl = xrt::kernel(device, uuid, "mkKernelTop", xrt::kernel::cu_access_mode::exclusive);
    ...
    boA.sync(XCL_BO_SYNC_BO_FROM_DEVICE);
